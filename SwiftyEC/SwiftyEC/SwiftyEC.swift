...
enum SwiftyEC {
    ...
    static func base64String(pemEncoded pemString: String) throws -> String {
        ...
        guard lines.count != 0 else {
            throw SwiftyECError.pemDoesNotContainKey
        }
    ...
    static func data(forKeyReference reference: SecKey) throws -> Data {
        ...
        if #available(iOS 10.0, *), #available(watchOS 3.0, *), #available(tvOS 10.0, *) {
            ...
            guard let unwrappedData = data as Data? else {
                throw SwiftyECError.keyRepresentationFailed(error: error?.takeRetainedValue())
            }
        ...
        // and delete the key again.
            ...
            guard let unwrappedData = data as? Data else {
                throw SwiftyECError.keyAddFailed(status: addStatus)
            }
    ...
    static func addKey(_ keyData: Data, isPublic: Bool, tag: String) throws ->  SecKey {
        ...
        guard let tagData = tag.data(using: .utf8) else {
            throw SwiftyECError.tagEncodingFailed
        }
        
        let keyClass = isPublic ? kSecAttrKeyClassPublic : kSecAttrKeyClassPrivate
//        let keyClass2 = isPublic ? "kSecAttrKeyClassPublic" : "kSecAttrKeyClassPrivate"
//        print("keyClass: ", keyClass2)
        
        // On iOS 10+, we can use SecKeyCreateWithData without going through the keychain
//        if #available(iOS 10.0, *), #available(watchOS 3.0, *), #available(tvOS 10.0, *) {
//            print("iOS 10.0 available")
...
//                throw SwiftyECError.keyCreateFailed(error: error?.takeRetainedValue())
//            }
//            print("key: ", key)
//            return key
//            
...
//        } else {
            ...
            guard let unwrappedKeyRef = keyRef else {
                throw SwiftyECError.keyCopyFailed(status: copyStatus)
            }
...
//        }
    ...
    static func stripKeyHeaderRSA(keyData: Data) throws -> Data {
        ...
        throw SwiftyECError.invalidAsn1Structure
    }
    
/**
 This method strips the header from a provided ASN.1 DER key.
 If the key doesn't contain a header, the DER data is returned as is.
